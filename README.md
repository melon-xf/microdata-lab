...
<p align="center"><strong>Oil jumped. Gas followed. Five-year inflation expectations didn’t.</strong><br>One command refreshes the official series and rebuilds the finding when the data change.</p>
...
https://github.com/melon-xf/microdata-lab/tree/public-release
...
git clone \
  ...
  --single-branch \
  https://github.com/melon-xf/microdata-lab.git
cd microdata-lab
```
